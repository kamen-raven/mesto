...
/* export const popupImageViewButtonClose = popupImageView.querySelector('.popup__close-button'); */
/* export const popupImageViewBigImage = popupImageView.querySelector('.popup__figure-img');
export const popupImageViewCaption = popupImageView.querySelector('.popup__figure-caption'); */
